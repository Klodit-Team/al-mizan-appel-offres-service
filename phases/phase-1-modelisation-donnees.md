...
2. Lance la commande de synchronisation :
   ...
   npx prisma db push
   ```
   *Cette commande crée les tables dans PostgreSQL sans avoir besoin de fichiers .entity.ts.*
...
npx prisma generate
```
*Cela crée un client typé dans ton dossier node_modules que tu utiliseras dans tes services.*
