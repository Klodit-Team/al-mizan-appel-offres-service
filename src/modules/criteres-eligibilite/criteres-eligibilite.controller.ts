...
export class CriteresEligibiliteController {
  constructor(private readonly criteresEligibiliteService: CriteresEligibiliteService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateCriteresEligibiliteDto: UpdateCriteresEligibiliteDto) {
    return this.criteresEligibiliteService.update(+id, updateCriteresEligibiliteDto);
  }
